...
import { add_updateOuterProjects } from '../../../../Firebase/OuterProjectsFirestore';
...
const AddNewOuter = () => {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLButtonElement>) : void => {
        ...
        add_updateOuterProjects(`/website/maxwin/projects/0/outer/${id}`,project, files, history);
