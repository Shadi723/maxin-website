...
import { add_updateInnerProjects } from '../../../../Firebase/InnerProjectsFirestore';
...
const AddNewInner = () => {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLButtonElement>) : void => {
        ...
        add_updateInnerProjects(`/website/maxwin/projects/1/inner/${id}`,project, files, history);
    ...
    return (
        <div className={classes.root}>
            <Grid container direction='column' justify='center' className={classes.rootGrid}>
                ...
                <Grid item className={classes.gridItem}>
                    <TextField   onChange={handleNameChange} placeholder='Project Name'/>
                </Grid>
